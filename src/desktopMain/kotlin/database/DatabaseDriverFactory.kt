...
actual open class DatabaseDriverFactory {
    actual open fun createDriver(): SqlDriver {
        val dbPath = platform.AppDirectories.dataDir.resolve("deckloot.db").toString()
        val driver = JdbcSqliteDriver("jdbc:sqlite:$dbPath", Properties(), DeckLootDatabase.Schema)
